...
if __name__ == '__main__':
    ...
    parser.add_argument('--resolution_depth', type=int, default=720, help="inference resolution of depth model, setting it to -1 will align with layerdiff")
    ...
    parser.add_argument('--tblr_split', action='store_true', default=True, help='split parts (handwear, eyes, etc) into left-right components (default: on)')
    parser.add_argument('--no_tblr_split', dest='tblr_split', action='store_false', help='disable left-right split')
